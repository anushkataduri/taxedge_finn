export const Routes = {
  ...
  SERVICES: {
    ...
    TDS_FORM: "/service/tds-form",
    TDS_CHECKLIST: "/service/tds-checklist",
    TDS_ESTIMATE: "/service/tds-estimate",
    TDS_PAYMENT: "/service/tds-payment",
    TDS_STATUS: "/service/tds-status",
