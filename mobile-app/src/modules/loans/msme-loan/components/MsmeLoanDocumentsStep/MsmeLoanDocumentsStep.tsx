...
import { styles } from "./MsmeLoanDocumentsStep.styles";

export interface MsmeLoanDocumentsStepProps {
...
export const MsmeLoanDocumentsStep: React.FC<MsmeLoanDocumentsStepProps> = ({
  documents,
  onDocumentUploaded,
}) => {
  ...
  const handleMockPdf = () => {
    ...
    const mockName = `${doc?.name.replace(/\s+/g, "_") || "msme_udyam_doc"}.pdf`;
    onDocumentUploaded(
      activeDocId,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.sectionTitle}>MSME Enterprise Documents</Text>
      <Text style={styles.sectionSubtitle}>
        Upload Udyam registration certificate, GST returns, and current bank statements for priority sector evaluation.
      </Text>
          ...
          <View style={styles.sheetContent}>
            ...
            >
              <Ionicons
                ...
                color={BrandColors.PRIMARY_BLUE}
              />
              <Text style={styles.sheetOptionText}>Attach MSME PDF Document</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
...
export default MsmeLoanDocumentsStep;
