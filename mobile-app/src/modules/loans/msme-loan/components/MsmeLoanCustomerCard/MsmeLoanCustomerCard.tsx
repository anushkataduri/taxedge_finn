...
import { styles } from "./MsmeLoanCustomerCard.styles";

export interface MsmeLoanCustomerCardProps {
  profile?: Partial<CustomerProfileSummary>;
}

export const MsmeLoanCustomerCard: React.FC<MsmeLoanCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.cardTitle}>MSME Enterprise Proprietor / Partner</Text>
        </View>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Primary applicant details are automatically retrieved from your customer records.
          Manual re-entry is avoided.
        </Text>
      </View>

      <View style={styles.detailsGrid}>
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Proprietor / Partner Name</Text>
        ...
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Enterprise Registered Address</Text>
...
export default MsmeLoanCustomerCard;
