...
import { styles } from "./HomeLoanCustomerCard.styles";

export interface HomeLoanCustomerCardProps {
  profile?: Partial<CustomerProfileSummary>;
}

export const HomeLoanCustomerCard: React.FC<HomeLoanCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Personal details are automatically loaded from your verified customer account.
...
export default HomeLoanCustomerCard;
