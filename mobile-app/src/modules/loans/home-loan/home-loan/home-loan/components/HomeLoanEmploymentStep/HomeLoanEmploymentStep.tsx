  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardDescription}>
          Select monthly household income range or enter your exact net income.
        </Text>
          ...
          {isCustomIncome && (
            <View style={styles.customInputContainer}>
              ...
              <TextInput
                ...
                placeholder="Enter monthly net income (₹) (e.g. 50000)"
      ...
      {/* Dropdown Modal for Monthly Household Income */}
      <Modal
        ...
        >
          ...
          >
            <View style={styles.modalHeaderRow}>
              <Text style={styles.modalTitle}>Select Monthly Household Income</Text>
