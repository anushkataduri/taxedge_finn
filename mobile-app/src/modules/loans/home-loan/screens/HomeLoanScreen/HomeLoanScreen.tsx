...
export const HomeLoanScreen: React.FC = () => {
  ...
  const [loanDetails, setLoanDetails] = useState<LoanDetailsFormData>({
    ...
    existingEmi: "",
    monthlyIncomeOrTurnover: "120000",
  ...
  const renderActiveStep = () => {
    switch (currentStepIndex) {
      case 0:
        return (
          <>
            <HomeLoanCustomerCard profile={customer || undefined} />
            <HomeLoanFinancialsStep
              data={loanDetails}
    ...
    <View style={[styles.safeArea, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => Alert.alert("Draft Saved", "Home loan draft saved successfully.")}
        >
