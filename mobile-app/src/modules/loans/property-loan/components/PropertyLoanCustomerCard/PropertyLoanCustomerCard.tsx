...
import { styles } from "./PropertyLoanCustomerCard.styles";

export interface PropertyLoanCustomerCardProps {
  profile?: Partial<CustomerProfileSummary>;
}

export const PropertyLoanCustomerCard: React.FC<PropertyLoanCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.cardTitle}>Property Title Holder / Applicant</Text>
        </View>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Applicant KYC is auto-populated from your central customer profile.
      ...
      <View style={styles.detailsGrid}>
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Applicant / Title Holder</Text>
...
export default PropertyLoanCustomerCard;
