...
import { styles } from "./WorkingCapitalCustomerCard.styles";

export interface WorkingCapitalCustomerCardProps {
  profile?: Partial<CustomerProfileSummary>;
}

export const WorkingCapitalCustomerCard: React.FC<WorkingCapitalCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.cardTitle}>Promoter / Signatory Profile</Text>
        </View>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Promoter credentials and KYC are securely retrieved from your user profile.
      ...
      <View style={styles.detailsGrid}>
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Applicant / Signatory</Text>
...
export default WorkingCapitalCustomerCard;
