...
export const BusinessLoanDocumentsStep: React.FC<BusinessLoanDocumentsStepProps> = ({
  ...
  const handleMockPdf = () => {
    ...
    const mockName = `${doc?.name.replace(/\s+/g, "_") || "financial_statement"}.pdf`;
    onDocumentUploaded(
      activeDocId,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.sectionTitle}>Commercial Audit Dossier</Text>
      <Text style={styles.sectionSubtitle}>
        Upload business registration, GST returns, and audited financials.
      </Text>
          ...
          <View style={styles.sheetContent}>
            ...
            >
              <Ionicons
                ...
                color={BrandColors.PRIMARY_BLUE}
              />
              <Text style={styles.sheetOptionText}>Attach CA Financials / GST PDF</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
