...
export const VehicleLoanDocumentsStep: React.FC<VehicleLoanDocumentsStepProps> = ({
  ...
  const handleMockPdf = () => {
    ...
    const mockName = `${doc?.name.replace(/\s+/g, "_") || "proforma"}_doc.pdf`;
    onDocumentUploaded(
      activeDocId,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.sectionTitle}>Vehicle Quotation & Income Dossier</Text>
      <Text style={styles.sectionSubtitle}>
        Upload dealer proforma invoice, KYC records, salary slips, and continuous bank statements.
      </Text>
          ...
          <View style={styles.sheetContent}>
            ...
            >
              <Ionicons
                ...
                color={BrandColors.PRIMARY_BLUE}
              />
              <Text style={styles.sheetOptionText}>Attach Quotation / Salary PDF</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
