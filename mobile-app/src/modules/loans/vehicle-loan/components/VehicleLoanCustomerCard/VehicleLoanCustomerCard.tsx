...
import { styles } from "./VehicleLoanCustomerCard.styles";

export interface VehicleLoanCustomerCardProps {
  profile?: Partial<CustomerProfileSummary>;
}

export const VehicleLoanCustomerCard: React.FC<VehicleLoanCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      <View style={styles.headerRow}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.cardTitle}>Borrower Identity Dossier</Text>
        </View>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Applicant KYC is auto-verified from your registered TaxEdge profile.
          Manual re-typing is omitted.
        </Text>
      </View>
...
export default VehicleLoanCustomerCard;
