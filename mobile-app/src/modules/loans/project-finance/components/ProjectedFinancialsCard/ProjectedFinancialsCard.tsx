...
import { styles } from "./ProjectedFinancialsCard.styles";

export interface ProjectedFinancialsCardProps {
  rows?: FiveYearRow[];
  data?: FiveYearRow[];
  isExpanded?: boolean;
  onToggleExpand?: () => void;
...
export const ProjectedFinancialsCard: React.FC<ProjectedFinancialsCardProps> = ({
  rows,
  data,
    ...
    <View style={styles.card}>
      ...
      >
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.cardTitle}>6. Projected Financials</Text>
        </View>
        <Ionicons
...
export default ProjectedFinancialsCard;
