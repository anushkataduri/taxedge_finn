...
export const PersonalLoanCustomerCard: React.FC<PersonalLoanCustomerCardProps> = ({
  profile,
}) => {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.infoBanner}>
        <Text style={styles.infoBannerText}>
          Personal details are securely fetched from your customer profile table.
...
export default PersonalLoanCustomerCard;
