...
} from "./IncomeDetailsScreen.styles";
import {
...
export const IncomeDetailsScreen: React.FC<IncomeDetailsScreenProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (!personalInfo.assessmentYear.trim()) {
      newErrors.assessmentYear = "Select an Assessment Year.";
    }

    // Validate Income Amount: numeric > 0
    const numericIncome = Number(incomeAmount.replace(/,/g, ""));
