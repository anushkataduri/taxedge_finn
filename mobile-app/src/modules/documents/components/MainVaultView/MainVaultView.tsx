...
import { styles, getCatIconWrapStyle } from "./MainVaultView.styles";
import type { CategoryInfo } from "../../types/documentTypes";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchBar}>
        <Ionicons name="search-outline" size={18} color={BrandColors.PRIMARY_BLUE} style={styles.searchIcon} />
        <TextInput
          value={query}
        ...
        />
        {query.length > 0 && (
          <TouchableOpacity onPress={() => setQuery("")} hitSlop={8} style={styles.iconButton}>
      ...
      <View style={styles.cardsList}>
        {filteredCategories.map((cat) => (
          ...
          >
            <View style={[styles.catIconWrap, getCatIconWrapStyle(cat.tintBg)]}>
